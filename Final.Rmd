...
This analysis uses public Eurostat datasets. Eurostat is the statistical
...
- There is a major disruption in GDP growth around years 2008-9
...
4th quarter is always the higher, while the 1st is always the lowest in each year.
The 2nd & 3rd are about the same. 


A lag plot would help us understand if there is autocorrelation in the time series.
...
Below there is an autocorrelation function plot. It will indicate us if there 
are significant autocorellations in the time series.
...
The final model is **ARIMA(2,1,1)(0,1,1)[4]**. Both seasonal and first differences 
have been used, indicated by the middle slot in each part of the model. Also 1 lagged error 
and 1 seasonally lagged error have been selected, indicated by the last slot in 
each part of the model. 2 autoregression terms have been used, indicated by the first slot in the 
model. No seasonal autoregression terms have been used used. 
